export default function Logo({ height, width }) {
    return (
        <svg width={width} height={height} viewBox="0 0 455 445" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_101_2)">
                ...
                <path d="M40.2977 432H140.632L231.94 261.946L250.5 227.5L233.5 190.5L169.06 316.811H66.2174L1 432H40.2977Z" fill="#EC521A" stroke="black" stroke-width="4" />
