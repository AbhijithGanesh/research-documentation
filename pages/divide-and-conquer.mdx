...
import MyComponent from "../components/links";
...
<Image src="/division.png" height={500} width={800} alt="Implementation of a 4 way sort"/>
...
<section class="flex lg:justify-between lg:w-full">
  <MyComponent
